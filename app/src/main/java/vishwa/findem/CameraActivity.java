...
//        }
 ...
 protected void setFragment() {
        ...
        Fragment fragment;
        if (useCamera2API) {
            vishwa.findem.CameraConnectionFragment camera2Fragment =
                    vishwa.findem.CameraConnectionFragment.newInstance(
                            new vishwa.findem.CameraConnectionFragment.ConnectionCallback() {
                                @Override
